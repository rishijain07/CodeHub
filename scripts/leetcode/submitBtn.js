...
const createToolTip = () => {
  ...
  toolTip.id = 'codehub-upload-tooltip';
  toolTip.textContent =
...
const createGitIcon = () => {
  ...
  uploadIcon.setAttribute('id', 'codehub-upload-icon');
...
function addManualSubmitBtn(eventHandler) {
  ...
  if (btns.innerText.includes('Solution') && !btns.innerText.includes('CodeHub')) {
    btns.appendChild(
      (() => {
        const btn = document.createElement('button');
        btn.innerText = 'Sync w/ CodeHub';
