import { CodeHubError } from "./util.js";
...
function appendProblemToReadme(topic, markdownFile, hook, problem) {
  const url = `https://github.com/${hook}/tree/master/LeetCode/${problem}`;
...
function sortTopicsInReadme(markdownFile) {
  ...
  if (leetCodeSection == null) throw new CodeHubError('LeetCodeTopicSectionNotFound');
